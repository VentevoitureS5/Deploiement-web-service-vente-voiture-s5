...
public class V_annonce_complet_current_monthController {
    ...
    public Response getV_annonce_complet_current_monthByIdModele(@PathVariable Integer id_modele) {
        ...
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdModele(id_modele));
        }catch(Exception ex){
    ...
    public Response getV_annonce_complet_current_monthByIdMarque(@PathVariable Integer id_marque) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdMarque(id_marque));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdTypeMoteur(@PathVariable Integer id_type_moteur) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdTypeMoteur(id_type_moteur));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdTaille(@PathVariable Integer id_taille) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdTaille(id_taille));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdUsers(@PathVariable Integer id_users) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdUsers(id_users));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdEnergie(@PathVariable Integer id_energie) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdEnergie(id_energie));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdTransmission(@PathVariable Integer id_transmission) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdTransmission(id_transmission));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdUsage(@PathVariable Integer id_usage) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdUsage(id_usage));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdCouleur(@PathVariable Integer id_couleur) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdCouleur(id_couleur));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
    ...
    public Response getV_annonce_complet_current_monthByIdTypeAnnonce(@PathVariable Integer id_type_annonce) {
        Response response = new Response();
        try{
            response.setDataOnSuccess(v_annonce_complet_current_monthService.getV_annonce_complet_current_monthByIdTypeAnnonce(id_type_annonce));
        }catch(Exception ex){
            response.setError(ex.getMessage());
        }
        return response;
